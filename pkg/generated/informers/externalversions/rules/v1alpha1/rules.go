...
import (
	...
	rulesv1alpha1 "github.com/41tair/rules-controller/pkg/apis/rules/v1alpha1"
	versioned "github.com/41tair/rules-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/41tair/rules-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/41tair/rules-controller/pkg/generated/listers/rules/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RulesV1alpha1().Ruleses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RulesV1alpha1().Ruleses(namespace).Watch(context.TODO(), options)
			},
		},
		&rulesv1alpha1.Rules{},
		resyncPeriod,
...
func (f *rulesInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rulesv1alpha1.Rules{}, f.defaultInformer)
}
