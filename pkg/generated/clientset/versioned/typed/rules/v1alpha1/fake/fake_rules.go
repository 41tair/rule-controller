...
var rulesesResource = v1alpha1.SchemeGroupVersion.WithResource("ruleses")

var rulesesKind = v1alpha1.SchemeGroupVersion.WithKind("Rules")
...
func (c *FakeRuleses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(rulesesResource, c.ns, name, opts), &v1alpha1.Rules{})
